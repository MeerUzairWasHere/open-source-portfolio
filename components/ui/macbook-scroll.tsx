...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100] md:min-h-[300vh]  flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50">
      <motion.h2
        style={{
    ...
    <div className="relative [perspective:800px]">
      <div
        ...
        <div
          ...
          className="absolute inset-0 bg-[#0B0B0F] rounded-lg flex items-center justify-center"></div>
      </div>
      <motion.div
        style={{
          scaleX: scaleX,
