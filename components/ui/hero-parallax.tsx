...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[2200px] md:h-[2500px] py-10 overflow-hidden w-full antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]">
